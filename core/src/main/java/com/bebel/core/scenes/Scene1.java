...
public class Scene1 extends BebelScene {
    ...
    protected void createImpl() {
        ...
        add("Chaine arriere droite", Scene1Assets.Chaines.ARRIERE_DROITE)
            ...
            .position(45.2f, 21.75f);

        bourru = (Personnage) add(new Personnage("Bourru", NainsAssets.Bourru.PHYSICS))
            .up(NainsAssets.Bourru.DOS_ANIM, NainsAssets.Bourru.FACE_IDLE, "face", BodyDef.BodyType.DynamicBody)
            .down(NainsAssets.Bourru.FACE_ANIM, NainsAssets.Bourru.FACE_IDLE, "face", BodyDef.BodyType.DynamicBody)
            .right(NainsAssets.Bourru.DROITE_ANIM, NainsAssets.Bourru.FACE_IDLE, "droite", BodyDef.BodyType.DynamicBody)
            .left(NainsAssets.Bourru.GAUCHE_ANIM, NainsAssets.Bourru.FACE_IDLE, "droite", BodyDef.BodyType.DynamicBody)
            .speed(11.15f)
            .activeClavier()
            .activeZ()
